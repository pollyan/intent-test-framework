...
def create_template():
    ...
    return jsonify(
        format_success_response(data=template.to_dict(), message="模板创建成功")
    )
...
def update_template(template_id):
    ...
    try:
        ...
        return standard_success_response(
            data=template.to_dict(), message="模板更新成功"
        )
...
def apply_template(template_id):
    ...
    try:
        ...
        return standard_success_response(
            data=testcase.to_dict(), message="模板应用成功，测试用例已创建"
        )
...
def get_template_categories():
    ...
    try:
        ...
        return standard_success_response(
            data={"categories": category_list, "count": len(category_list)}
        )
